	...
	public PessoaFisica(){
		...
		btnSalvar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				try {
					Connection connection = JdbUtilPF.getConnection();
					 
					 PessoaFisicaJdbcDAO pfc = new PessoaFisicaJdbcDAO(connection);
					 pfc.salvar (pessoaFisica);
		...
		btnImprimir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog (null, "Nome: " +pessoaFisica.getNome()+
